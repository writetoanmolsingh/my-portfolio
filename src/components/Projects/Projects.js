  ...
  &:hover {
    ...
    box-shadow: 0 15px 30px
      rgba(
        ...
        0,
        0,
        ${(props) => (props.theme.name === "dark" ? "0.4" : "0.15")}
      );
  }
`;
  ...
  const projects = [
    {
      ...
      description:
        "Developed a sleek personal portfolio using JavaScript and React, showcasing projects and skills. Added light/dark mode toggle and optimized for responsiveness and smooth navigation across devices.",
      showLink: true,
    ...
    },
    {
      ...
      description:
        "Developed a fully responsive AI chatbot integrated with GPT-4o, featuring a React frontend and Python Flask backend. The system allows users to upload PDF files and delivers contextual insights by analyzing document content.",
      showLink: true,
